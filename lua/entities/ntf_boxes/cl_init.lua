	...
	ang:RotateAroundAxis(self:GetAngles():Right(),270)
		...
		if self:GetPos():Distance( LocalPlayer():GetPos()) < 400 then
			cam.Start3D2D(self:GetPos()+ang:Up()*6.4,ang,0.03)
				...
				draw.SimpleText(TobaccoFactory.Config.Lang.CigaretteBoxes,"ntf_very_small",0,-200,Color(255,255,255,DisColor),1,0)
				draw.SimpleText(self:Getamount().." "..TobaccoFactory.Config.Lang.BoxesLeft,"ntf_very_small",0,-150,Color(255,255,255,DisColor),1,0)
			cam.End3D2D()
		end
